...
export function LandingHero({
  ...
  return (
    <section className="mx-auto max-w-3xl px-6 py-16 text-center">
      ...
      <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-4 text-sm leading-6 text-slate-700 shadow-sm">
        <p>No account required. No document storage in this first version.</p>
        <p className="mt-2">
          Plainly helps you understand text. It is not a substitute for legal,
